...
public class IncidenceArrayGraph implements Graph{
    ...
    @Override
    public void addVertex(Vertex vertex1) throws GraphException {
        if(nbVertex<this.maxVertex){
            this.vertexArray[nbVertex] = vertex1;
            nbVertex++;
        }
        else{
            throw new GraphException("Vertex maximum reached");
        }
    }

    @Override
    public void addEdge(Vertex vertex1, Vertex vertex2, EdgeKind edgeKind) throws GraphException {
        if(nbEdge<this.maxVertex*this.maxVertex){
            ...
            throw new GraphException("Edge maximum reached");
        }
    }
